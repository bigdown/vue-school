...
/***/ function(module, exports) {
	...
	// <template>
	// 	<footer>
	// 		<div v-link="{ path: '/home' }" class="home"></div>
	// 		<div v-link="{ path: '/message' }" class="message"></div>
	// 		<div v-link="{ path: '/clame' }" class="clame"></div>
	// 		<div v-link="{ path: '/line' }" class="line"></div>
	// 	</footer>
	// </template>
	//
	// <script>
...
/***/ function(module, exports) {
	...
	module.exports = "\n\t<footer _v-022af059=\"\">\n\t\t<div v-link=\"{ path: '/home' }\" class=\"home\" _v-022af059=\"\"></div>\n\t\t<div v-link=\"{ path: '/message' }\" class=\"message\" _v-022af059=\"\"></div>\n\t\t<div v-link=\"{ path: '/clame' }\" class=\"clame\" _v-022af059=\"\"></div>\n\t\t<div v-link=\"{ path: '/line' }\" class=\"line\" _v-022af059=\"\"></div>\n\t</footer>\n";
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "E:\\nodejs\\vue-school\\src\\clame.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../node_modules/css-loader/index.js!./../node_modules/vue-loader/lib/style-rewriter.js?id=_v-5eb16c22&file=clame.vue&scoped=true!./../node_modules/vue-loader/lib/selector.js?type=style&index=0!./clame.vue", function() {
				var newContent = require("!!./../node_modules/css-loader/index.js!./../node_modules/vue-loader/lib/style-rewriter.js?id=_v-5eb16c22&file=clame.vue&scoped=true!./../node_modules/vue-loader/lib/selector.js?type=style&index=0!./clame.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _sheader = __webpack_require__(15);

	var _sheader2 = _interopRequireDefault(_sheader);

	var _sfooter = __webpack_require__(20);
	...
	// <template>
	// 	<div>
	// 		<sheader :raction="raction" :laction="laction" :title="title"></sheader>
	// 		<div class="scontent">
	// 			<p>123</p>
	//
	// 		</div>
...
/***/ function(module, exports) {
	...
	module.exports = "\n\t<div _v-5eb16c22=\"\">\n\t\t<sheader :raction=\"raction\" :laction=\"laction\" :title=\"title\" _v-5eb16c22=\"\"></sheader>\n\t\t<div class=\"scontent\" _v-5eb16c22=\"\">\n\t\t\t<p _v-5eb16c22=\"\">123</p>\n\t\t\t\n\t\t</div>\n\t\t<sfooter _v-5eb16c22=\"\"></sfooter>\n\t</div>\n";
